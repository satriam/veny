...
<table id="data" class="table table-bordered table-striped table-scalable">
	...
	?>
</table><div id="ModalAdd" class="modal fade" tabindex="-1" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="pelanggan_add.php" name="modal_popup" enctype="multipart/form-data" method="post">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<div class="input-group-addon">
									...
									<input name="no_pelanggan" type="text" class="form-control" placeholder="Nomor Handphone"/>
							</div>
						</div>
